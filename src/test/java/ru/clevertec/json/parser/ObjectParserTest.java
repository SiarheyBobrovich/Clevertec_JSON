...
class ObjectParserTest {
    ...
    void checkParseJsonNames() {
        ...
        Map<String, String> actual = parser.parseJson(json);
        assertTrue(names.containsAll(actual.keySet()));
    }
    
    @Test
    void checkParseJsonValues() {
        String json = "{\"aByte\":39," +
                "\"aShort\":10823," +
                "\"aChar\":\"僻\"," +
                "\"anInt\":1300184486," +
        ...
        assertTrue(values.containsAll(actual.values()));
    }
}
